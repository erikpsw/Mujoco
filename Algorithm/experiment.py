...
# vel = [1000, 20, 1000, 20]
vel=[0,0,0,0,0,0]
target_get_joint_angles=np.array([0,-1.5,0.3,1.4,0,0])
d1=300
start=0
end=d1
...
start_pos = np.array([0.04866695,  0.0030341 ,  0.2716533]) - origin_pos
...
while True:
    ...
    #     print("change")
    #     if times==0:
    #         target_get_joint_angles=np.array([0,-1.2,1.1,1,0,-0.2])
    #         delta_joints=(target_get_joint_angles-joint_angles)/d2
    #         end=idx+d2
    #     times+=1
    #     start=idx
