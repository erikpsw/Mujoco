...
# 计算MPC所需矩阵
H, E, M = cal_matrices(A,B,Q,w,N,R)
...
plt.plot(X_k[0, 1:], label='Position', color='b')
plt.axhline(0, color='r', linestyle='--', label='y=0')  # Horizontal line at y=0
...
plt.plot(X_k[1, 1:], label='Velocity', color='g')
